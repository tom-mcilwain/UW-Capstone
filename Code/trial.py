...
TRIAL
-----
This script is the backbone behind the entire kinematic interface.
...
def run(stream, cursors, save_data, session_length, dimensions):
    ...
    # For each glove state as the stream is running
    for state in stream:
